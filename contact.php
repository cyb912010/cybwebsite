<div class='contact' ng-controller="myCtrl" >
     <div class='half '>
     ...
     <form id="form" name="form" novalidate ng-submit="processForm()" onsubmit="return successful()" method="GET">
      ...
      <ul >
        <li><textarea    style="font-size:16px" cols="40" rows="1" name="name" ng-required="true" ng-model="formData.name" placeholder="Name"></textarea></li>
         <p class="error" ng-cloak ng-show="form.name.$invalid && form.name.$touched ">Please enter a name.</p>
        <li><textarea    style="font-size:16px" cols="40" rows="1" name="email" ng-required="true" ng-model="formData.email" type="email" placeholder="Email"></textarea></li>
         <p class="error" ng-cloak ng-show="form.email.$invalid && form.email.$touched ">Please enter an correct email.</p>
        <li><textarea    style="font-size:16px" cols="40" rows="1" name="subject" ng-model="formData.subject" placeholder="Subject"></textarea></li>
        <li><textarea    style="font-size:16px" cols="40" rows="5" name="message"  placeholder="Message" ng-model="formData.message" ng-required="true"></textarea></li>      
